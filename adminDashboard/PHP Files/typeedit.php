...
if(isset($_POST['add'])){
  ...
  $query = mysqli_query($connect,"UPDATE `status_tbl` SET `s_status`='$name' WHERE s_id='$id'");
  echo "<script>window.location.assign('producttypetable.php')</script>";
}
                    ...
                    <div class="row align-items-center">
                        <div class="border-0 mb-4">
                            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                <h3 class="fw-bold mb-0">Edit Product Type</h3>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        include "connection.php";
                                        $id=$_GET['id'];
                                        $query=mysqli_query($connect,"Select * from status_tbl where s_id='$id'");   
                                        $row=mysqli_fetch_assoc($query);
                                        ?>
                                        <div class="g-3 align-items-center">
                                            <div class="col-md-6">
                                                <label  class="form-label">Product Type</label>
                                                <input type="text" name="ptype" value="<?php echo $row['s_status']?>" class="form-control" pattern="[A-Z a-z]{4,50}" required>
                                            </div>
                                            <br>
