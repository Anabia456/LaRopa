                ...
                <div class="main-content col-md-12">
                    ...
                    <div class=" auto-clear lynessa-products">
                        ...
                        <?php
                            ...
                            $query = mysqli_query($connect,"SELECT * FROM `product_tbl` P inner join status_tbl Z on Z.s_id=P.status WHERE p_category = '3' AND p_subcategory = '16' AND s_id='5'");
                            ...
                            <li class="product-item wow fadeInUp product-item rows-space-30 col-bg-3 col-xl-3 col-lg-4 col-md-6 col-sm-6 col-ts-6 style-01 post-28 product type-product status-publish has-post-thumbnail product_cat-light product_cat-chair product_cat-sofas product_tag-light product_tag-sock  instock sale featured shipping-taxable purchasable product-type-simple"
                                ...
                                <div class="product-inner tooltip-left">
                                    <div class="product-thumb">
                                        <a class="thumb-link" href="quickView.php?id=<?php echo $fetch['p_id']?>&name=kidsEast.php">
                                        ...
                                        <a href="quickView.php?id=<?php echo $fetch['p_id']?>&name=kidsEast.php" class="button yith-wcqv-button" data-product_id="24">Quick View</a>
                                        <div class="group-button">
                                            <div class="yith-wcwl-add-to-wishlist">
                                                <div class="yith-wcwl-add-button show">
                                                    <a href="addtowishlist.php?id=<?php echo $fetch['p_id']?>&name=kidsEast.php?>" class="add_to_wishlist">Add to Wishlist</a>
                                                </div>
                                            </div>
                                            <a href="quickView.php?id=<?php echo $fetch['p_id']?>&name=kidsEast.php" class="button yith-wcqv-button">Quick View</a>
                                            <div class="add-to-cart">
                                                <a href="addtocart.php?id=<?php echo $fetch['p_id']?>&name=kidsEast.php" class="button product_type_simple add_to_cart_button">Add to
                                                    cart</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="group-button">
                                        <div class="group-button-inner">
                                            ...
                                            <a href="quickView.php?id=<?php echo $fetch['p_id']?>&name=kidsEast.php" class="button yith-wcqv-button">Quick View</a>
                                            <div class="add-to-cart">
                                                <a href="addtocart.php?id=<?php echo $fetch['p_id']?>&name=kidsEast.php" class="button product_type_variable add_to_cart_button">Add To Cart
                                                    </a>
                                            </div>
                                        </div>
                                    </div>
