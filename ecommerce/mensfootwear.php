            ...
            <div class="categories-list-owl owl-slick equal-container better-height"
                ...
                <div class="categories-item rows-space-0 post-740 page type-page status-publish hentry">
                    <div class="categories-inner">
                        ...
                        <h3 class="title">
                            <a href="mensWest.php" tabindex="-1"> Western Wear </a>
                        </h3>
                    </div>
                </div>
                ...
                <div class="main-content col-md-12">
                    ...
                    <div class=" auto-clear lynessa-products">
                        ...
                        <?php
                            ...
                            $query = mysqli_query($connect,"SELECT * FROM `product_tbl` P inner join status_tbl Z on Z.s_id=P.status WHERE p_category = '1' AND p_subcategory = '22' AND s_id='5'");
                                        ...
                                        <div class="group-button">
                                            <div class="yith-wcwl-add-to-wishlist">
                                                <div class="yith-wcwl-add-button show">
                                                    <a href="addtowishlist.php?id=<?php echo $fetch['p_id']?>&name=mensfootwear.php?>" class="add_to_wishlist">Add to Wishlist</a>
                                                </div>
                                            </div>
                                            <a href="quickView.php?id=<?php echo $fetch['p_id']?>&name=mensfootwear.php" class="button yith-wcqv-button">Quick View</a>
                                            <div class="add-to-cart">
                                                <a href="addtocart.php?id=<?php echo $fetch['p_id']?>&name=mensfootwear.php" class="button product_type_simple add_to_cart_button">Add to
                                                    cart</a>
                                            </div>
                                        </div>
                                    </div>
