<footer id="footer" class="footer style-04">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-lg-12 d-lg-none">
                    ...
                    <div class="footer-desc">Lynessa helps you sell anything.<br/>
                ...
                <div class="col-lg-6 d-none d-lg-block">
                    <div class="logo-footer">
                        <img src="../Images/logo4.png"
                             class="az_single_image-img attachment-full" style="height: 120px; width:50%;" alt="img">
                    </div>
                    <div class="footer-desc">Lynessa helps you sell anything.<br/>
                        The best choice for your next personal
                    </div>
    ...
    <div class="section-016">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p>© Copyright 2022 <a href="#">La Ropa</a>. All Rights Reserved.</p>
                </div>
                <div class="col-md-6">
                    <div class="payment">
